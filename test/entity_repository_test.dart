...
void main() {
  test('Create Entity', () {
    ...
    expect(entityRepository.entities[0].properties.length, 4);
    ...
    expect(entityRepository.entities[0].properties[3].key, "height");
    expect(entityRepository.entities[0].properties[3].type,
        EntityPropertyType.double);
  });
}
